...
ADD https://dl.ubnt.com/unifi/5.6.39-7b9a227a14/UniFi.unix.zip /tmp/UniFi.unix.zip
ADD https://dl.ubnt.com/unifi/5.6.39-7b9a227a14/unifi_sh_api /usr/local/bin/unifi_sh_api
