...
ADD https://dl.ubnt.com/unifi/5.8.12-e2c271f29d/UniFi.unix.zip /tmp/UniFi.unix.zip
ADD https://dl.ubnt.com/unifi/5.8.12-e2c271f29d/unifi_sh_api /usr/local/bin/unifi_sh_api
