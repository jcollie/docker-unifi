...
ADD https://dl.ubnt.com/unifi/5.6.31-e6237920d0/UniFi.unix.zip /tmp/UniFi.unix.zip
ADD https://dl.ubnt.com/unifi/5.6.31-e6237920d0/unifi_sh_api /usr/local/bin/unifi_sh_api
