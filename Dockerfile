...
ADD https://dl.ubnt.com/unifi/5.9.32-016da0b7c1/UniFi.unix.zip /tmp/UniFi.unix.zip
ADD https://dl.ubnt.com/unifi/5.9.32-016da0b7c1/unifi_sh_api /usr/local/bin/unifi_sh_api
