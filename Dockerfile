...
ADD https://dl.ubnt.com/unifi/5.8.23-d5a5bbfda4/UniFi.unix.zip /tmp/UniFi.unix.zip
ADD https://dl.ubnt.com/unifi/5.8.23-d5a5bbfda4/unifi_sh_api /usr/local/bin/unifi_sh_api
