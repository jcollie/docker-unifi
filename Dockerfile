...
ADD https://dl.ubnt.com/unifi/5.6.35-cbc0f14bcb/UniFi.unix.zip /tmp/UniFi.unix.zip
ADD https://dl.ubnt.com/unifi/5.6.35-cbc0f14bcb/unifi_sh_api /usr/local/bin/unifi_sh_api
