...
ADD https://dl.ubnt.com/unifi/5.8.17-7f48eb2dea/UniFi.unix.zip /tmp/UniFi.unix.zip
ADD https://dl.ubnt.com/unifi/5.8.17-7f48eb2dea/unifi_sh_api /usr/local/bin/unifi_sh_api
